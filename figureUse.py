...
def pic1(figGen):
    ...
    # text_q = '全市平均水平'
    # #  complete_date 表连接操作
    # figGen.drawDistrict('10-1', "early.service_code = exam.service_code and early.mens_time - exam.input_date_archive_ymd between -30 and 365", "early.service_code = exam.service_code", "exam, early", config.year,
...
def pic2(figGen):
    ...
    text_q = '全市平均水平'
    figGen.drawDistrict('26', "nation_h!='汉族'", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=["b"])
    figGen.drawDistrict('27', "nation_w!='汉族'", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
...
def pic3_2(figGen):
    ...
    text_q = '全市平均水平'
    figGen.drawDistrict('39', "had_adverse_pregnancy_outcome_w=1", "had_adverse_pregnancy_outcome_w is not null", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=["r"])
    figGen.drawYearDistrict('40', "had_adverse_pregnancy_outcome_w=1", "had_adverse_pregnancy_outcome_w is not null", "exam", config.year, 2,
...
def pic3_3(figGen):
    ...
    list_a = ['suffered_disease_gaoxueya_h=1', 'suffered_disease_xinzangbing_h=1', 'suffered_disease_tangniaobing_h=1', 'suffered_disease_dianxian_h=1', 'suffered_disease_jiazhuangxian_h=1',
    ...
    list_a = ['suffered_disease_gaoxueya_h=1', 'suffered_disease_jiazhuangxian_h=1', 'suffered_disease_tangniaobing_h=1']
    ...
    text_q = '全市平均水平'
    figGen.drawDistrict('55-1',"(check_value_xuetang_w >= 6.10)","check_value_xuetang_w is not null", "exam",
                        config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawDistrict('55-2',
                        "(check_value_xuetang_w>=7.0 or suffered_disease_tangniaobing_w=1)",
                        "(check_value_xuetang_w is not null or suffered_disease_tangniaobing_w is not null)", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])

    figGen.drawYearDistrict('56-1', "(check_value_xuetang_w >= 6.10)","check_value_xuetang_w is not null", "exam", config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")
    figGen.drawYearDistrict('56-2', "(check_value_xuetang_w>=7.0 or suffered_disease_tangniaobing_w=1)",
                        "(check_value_xuetang_w is not null or suffered_disease_tangniaobing_w is not null)", "exam", config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")

    text_q = '全市平均水平'
    figGen.drawDistrict('57', "(check_value_cujiazhuangxianjisu_w<0.44 or check_value_cujiazhuangxianjisu_w>3.45)", "check_value_cujiazhuangxianjisu_w is not null", "exam",
                        config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawYearDistrict('58', "(check_value_cujiazhuangxianjisu_w<0.44 or check_value_cujiazhuangxianjisu_w>3.45)", "check_value_cujiazhuangxianjisu_w is not null", "exam", config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")

    list_a = ["check_value_ganshenggongnengzhuananmei_w>45", "check_value_ganshenggongnengzhuananmei_h>45"]
    list_d = ["check_value_ganshenggongnengzhuananmei_w is not null", "check_value_ganshenggongnengzhuananmei_h is not null"]
    labels = ['女性', '男性']
    ...
    list_a = ["(check_value_ganshengongnengjigan_w>73 or check_value_ganshengongnengjigan_w<41)", "(check_value_ganshengongnengjigan_h > 97 or check_value_ganshengongnengjigan_h<57)"]
    list_d = ["check_value_ganshengongnengjigan_w is not null", "check_value_ganshengongnengjigan_h is not null"]
    labels = ['女性', '男性']
...
def pic3_4(figGen):
    text_q = '全市平均水平'
    figGen.drawDistrict('65', "(suffered_disease_jiehe_w=1 or suffered_disease_yixingganyan_w=1 or suffered_disease_linbingmeiduyiyuanti_w=1)",
                        "is_had_disease_w is not null", "exam",
                        config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawDistrict('66', "(suffered_disease_jiehe_h=1 or suffered_disease_yixingganyan_h=1 or suffered_disease_linbingmeiduyiyuanti_h=1)",
                        "is_had_disease_h is not null", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawYearDistrict('67', "(suffered_disease_jiehe_w=1 or suffered_disease_yixingganyan_w=1 or suffered_disease_linbingmeiduyiyuanti_w=1)",
                        "is_had_disease_w is not null", "exam",
                            config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")
    figGen.drawYearDistrict('68', "(suffered_disease_jiehe_h=1 or suffered_disease_yixingganyan_h=1 or suffered_disease_linbingmeiduyiyuanti_h=1)",
                        "is_had_disease_h is not null", "exam",
                            config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")

    list_a1 = ['suffered_disease_jiehe_w=1', 'suffered_disease_yixingganyan_w=1',
    ...
    figGen.drawDistrict('70', "(check_value_bingdushaichajuxibaoigm_w=1)", "", "exam",
                        config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawDistrict('71', "(check_value_bingdushaichagognxingtiigm_w=1)", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])
    figGen.drawDistrict('72', "(check_value_bingdushaichafengzhengbingdu_w=1)", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=[])

    list_a = ["check_value_yiganxueqinghbsag_w=1", "check_value_yiganxueqinghbsag_h=1"]
    list_d = ["", ""]
    labels = ['女性', '男性']
    ...
    text_q = '全市平均水平'
    figGen.drawDistrict('74', "check_value_meiduluoxianti_h=1)", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=['b'])
    figGen.drawDistrict('75', "check_value_meiduluoxuanti_w=1)", "", "exam", config.year,
                        isPercent=True, complete=True, figureText=text_q,
                        yLable="百分比（%）", colorList=['r'])

    figGen.drawYearDistrict('76', "(check_value_meiduluoxuanti_w=1)", "", "exam",
                            config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")
    figGen.drawYearDistrict('77', "(check_value_meiduluoxianti_h=1)", "", "exam", config.year, 2,
                            isPercent=True, complete=True, yLable="百分比（%）")
...
def pic3_5(figGen):
    ...
    text_q = '全市平均水平'
    figGen.drawDistrict('92',"(is_somke_w=1)","is_somke_w is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=["r"])
    figGen.drawDistrict('93',"(is_somke_h=1)","is_somke_h is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=["b"])
    ...
    figGen.drawYearDistrict('96',"(is_somke_w=1)","is_somke_w is not null","exam",config.year,2,
                           isPercent=True, complete=True,yLable="百分比（%）")
    figGen.drawYearDistrict('97',"(is_somke_h=1)","is_somke_h is not null","exam",config.year,2,
                           isPercent=True, complete=True,yLable="百分比（%）")

    text_q = '全市平均水平'
    figGen.drawDistrict('98',"(is_drink_w=1 or is_drink_w=3)","is_drink_w is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=[])
    figGen.drawDistrict('99',"(is_drink_h=1 or is_drink_h=2)","is_drink_h is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=[])

    figGen.drawYearDistrict('100',"(is_drink_w=3)","is_drink_w is not null","exam",config.year,2,
                           isPercent=True, complete=True,yLable="百分比（%）")
    figGen.drawYearDistrict('101',"(is_drink_h=2)","is_drink_h is not null","exam",config.year,2,
                           isPercent=True, complete=True,yLable="百分比（%）")

    text_q = '全市平均水平'
    figGen.drawDistrict('102',"(is_harmful_environment_h=1)","is_harmful_environment_h is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=["b"])
    figGen.drawDistrict('103',"(is_harmful_environment_m=1)","is_harmful_environment_m is not null","exam",config.year,
                           isPercent=True,  complete= True,figureText=text_q,
                            yLable="百分比（%）",colorList=["r"])
    ...
    figGen.drawDisease('104',list_a, list_d, labels,"exam", "all",config.year,
                           isPercent=True, complete=True,picType="bar",
                           yLable="百分比（%）")
    list_a = ['harmful_environment_shexian_w=1', 'harmful_environment_zaoyin_w=1',
              'harmful_environment_qiangongzhongjinshu_w=1',
              'harmful_environment_xinzhuangxiu_w=1', 'harmful_environment_gaowen_w=1',
              'harmful_environment_jiechumaogoushengchu_w=1', 'harmful_environment_zhendong_w=1',
              'harmful_environment_nongyao_w=1']
    list_d = ['harmful_environment_shexian_w is not null', 'harmful_environment_zaoyin_w is not null',
              ...
              'harmful_environment_jiechumaogoushengchu_w is not null', 'harmful_environment_zhendong_w is not null',
